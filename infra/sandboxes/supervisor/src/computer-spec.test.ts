...
import { COMPUTER_IMAGE, containerCreateOptions, containerNameFor, screenUrlFor, xdotoolCommand } from "./computer-spec.js";
...
describe("graphical computer spec", () => {
  ...
  it("turns takeover input into xdotool", () => {
    expect(xdotoolCommand({ kind: "key", key: "Enter" })).toEqual(["xdotool", "key", "--clearmodifiers", "Return"]);
