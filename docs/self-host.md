...
2. `docker compose -f infra/compose/docker-compose.yml up --build`
3. Open the web origin and create the first user. That user becomes the deployment owner.
...
OPENROUTER_API_KEY=
E2B_API_KEY=
SANDBOX_PROVIDER=docker   # or fake | e2b | e2b-emulator
AGENT_RUNTIME=pi          # or scripted
```
